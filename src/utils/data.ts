...
export const TEST_NESTED_FORM_DATA: IFormVariable[] = [
  ...
  {
    name: "selectMultiGroup",
    display: "Select multiple item",
    type: "selectgroup",
    description: "",
    default: [],
    required: false,
  ...
  {
    name: "selectGroupWithIcons",
    display: "Select single item with icons",
    type: "selectgroup",
    description: "",
    default: [],
    required: false,
  ...
  {
    name: "selectMultiGroupWithIcons",
    display: "Select multiple item with icons",
    type: "selectgroup",
    description: "",
    default: [],
    required: false,
